...
home_name = pwd;
dir_name = 'C:\Users\ys151\Desktop\WorkingZone\Gal\LowOdGrowth_12_FEB_2014\';
cd(dir_name);
filename = 'LowOdGrowth_12_FEB_2014'
load(filename)
cd(home_name);
...
well_num_str= {'01' '02' '03' '04' '05' '06' '07' '08' };
well_letter = {'A' 'B' 'C'};
...
for i = 1:8
    ...
    s = fit(t(i,7:12)',log(counts_mat(i,7:12))','a*x+b','robust','off');
    m(i) = s.a;
    C(:,:,i) = confint(s,0.682);
    figure(5)
    subplot(3,3,i);
    plot(t(i,7:12)',log(counts_mat(i,7:12))','.');hold on;
    plot(t(i,7:12)',s(t(i,7:12)'));
    [R,P] = corrcoef(s(t(i,7:12)'),log(counts_mat(i,7:12))');
